...
function Intro (){
    return(
        <div className='m-8 mt-6 py-4 bg-rose-300 bg-opacity-50 lg:flex font-a text-2xl bg-black-300 w-auto h-auto relative rounded-3xl overflow-hidden'>
            <video src={v1} autoPlay muted loop className='lg:mx-4 p-4 w-auto lg:w-1/2 lg:mr-5 '/>
            <div className=' bg-rose-400 bg-opacity-50 p-2 rounded-b-3xl  lg:rounded-b-none lg:rounded-r-3xl text-blue-1000'>
            <p className=' text-xl  mt-4 '>At the heart of Cakelisious beats a fervent passion for the harmonious marriage of exceptional taste and stunning design. Our vision is to redefine the art of cake-making by infusing it with creativity, innovation, and an unbridled passion for perfection. From the very inception, our vision has been clear — to redefine the art of cake-making by infusing it with creativity, innovation, and an unbridled passion for perfection.
            </p>
